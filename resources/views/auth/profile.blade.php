                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('profile') }}">
                        ...
                        <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="city" type="text" class="form-control" name="city" value="{{ old('city', $user->city) }}" required autofocus>
                        ...
                        <div class="form-group">
                            <label for="password-confirm" class="col-md-4 control-label">Подтверждение нового пароля</label>
